...
| F03 | Windows shell, native picker | F02 | Код и CI добавлены; native запуск ещё не подтверждён |
...
| F06 | Windows installer | F03,F04 | Workflow добавлен; нужен успешный CI и ручной smoke Win10/11 |
